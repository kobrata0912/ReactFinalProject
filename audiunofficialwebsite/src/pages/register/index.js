...
const Register = (props) => {
	...
	const isInvalid = 
	password !== rePassword || password === '' || rePassword === '' || email === '' || firstName === '' || lastName === ''

	const handleRegister = (event) => {
		event.preventDefault();
		props.firebase.doCreateUserWithEmailAndPassword(email, password, firstName, lastName)
		.then(authUser => {
			setFirstName('')
			setLastName('')
			setEmail('')
		...
		<div className="row">
			...
			<div className="col-8 border shadow-lg p-3 mb-5 bg-white rounded">
				<form onSubmit={handleRegister} >
					<div className="row">
						<div className="col">
							<label htmlFor="firstName" className="h4">Име</label>
							<input
								name="firstName"
								type="text"
						...
						<div className="col">
							<label htmlFor="lastName" className="h4">Фамилия</label>
							<input
								name="lastName"
								type="text"
								className="form-control"
					...
					<div className="form-group">
						<label htmlFor="rePassword" className="h4">Повторна парола</label>
						<input
							name="rePassword"
							placeholder="Password > 8 characters"
							type="password"
